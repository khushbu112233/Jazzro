...
public class GetallPhoneContact_auto_sync extends Service {
          ...
          //  ContentResolver contentResolver = getContentResolver();
           ...
           // Cursor cursor = contentResolver.query(ContactsContract.Data.CONTENT_URI, null, whereName, whereNameParams, ContactsContract.CommonDataKinds.StructuredName.GIVEN_NAME);
                            ...
                            if(cursor.getCount()>0) {
                                ...
                                Log.e("last_sync_contact_id", "first-------------" + Pref.getValue(getApplicationContext(), "last_sync_contact_id", 0));
                                ...
                                if (contacArray.length() > 0) {
                                    if(CheckInternet.isInternetConnected(GetallPhoneContact_auto_sync.this)) {
                                        ...
                                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                                            ...
                                            new ExecuteContactTask(contacArray, GetallPhoneContact_auto_sync.this).execute();
                                        }
                                    } else {
                                        Toast.makeText(GetallPhoneContact_auto_sync.this, getResources().getString(R.string.NO_INTERNET_CONNECTION), Toast.LENGTH_SHORT).show();
                                    }
